            ...
            <div className="flex-1 flex flex-col">
                ...
                <div className="bg-white border-b border-gray-200 p-6 flex-shrink-0">
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-2xl font-semibold text-gray-900">University Recommendations</h1>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                ...
                                <div className="flex items-end">
                                    <button
                                        ...
                                        className="w-full px-3 py-2 border border-gray-300 rounded-lg hover:bg-gray-100 transition-colors"
                                    >
                                        Clear filters
                                    </button>
                                </div>
                                    ...
                                    <div className="p-6">
                                        ...
                                        <div className="flex items-start justify-between mb-4">
                                            <div className="flex items-center space-x-3">
                                                <div className="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center">
                                                    <IoSchoolOutline className="w-6 h-6 text-black" />
                                                </div>
                                                <div>
                                                    ...
                                                    {university.ranking && (
                                                        <div className="flex items-center space-x-1 mt-1">
                                                            ...
                                                            <span className="text-sm text-gray-600">Ranked #{university.ranking}</span>
                                                        </div>
                                                    )}
                                                </div>
                                            </div>
                                        ...
                                        <div className="relative mb-4">
                                            ...
                                            <div className="absolute bottom-3 left-3 bg-white/90 backdrop-blur-sm rounded-lg px-3 py-1.5">
                                                <div className="flex items-center space-x-2">
                                                    <IoLocationOutline className="w-4 h-4 text-gray-700" />
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                                <div className="flex items-center space-x-2">
                                                    <IoCashOutline className="w-4 h-4 text-green-600" />
                                                    <span className="text-sm font-medium text-gray-700">Cost per year</span>
                                                </div>
                                            ...
                                            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                                <div className="flex items-center space-x-2">
                                                    <IoTimeOutline className="w-4 h-4 text-black" />
                                            ...
                                            {university.programs && university.programs.length > 0 && (
                                                <div className="p-3 bg-gray-50 rounded-lg">
                                                    <div className="flex items-center space-x-2 mb-2">
                                                        <IoGlobeOutline className="w-4 h-4 text-purple-600" />
                                            ...
                                            <div className="p-3 bg-gray-100 rounded-lg">
                                                <h4 className="text-sm font-medium text-gray-900 mb-1">Why it's a good fit</h4>
                                                <p className="text-sm text-gray-700 leading-relaxed">{university.reasons || "Great match for your academic interests and career goals."}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="mt-4">
                                            {university.website ? (
                                                <a
                                                    ...
                                                    className="w-full block px-4 py-2 bg-gray-800 text-white rounded-lg hover:bg-gray-700 transition-colors text-sm font-medium text-center"
                                                >
                                                    Visit Website
                                                </a>
                                            ) : (
                                                <button className="w-full px-4 py-2 bg-gray-300 text-gray-500 rounded-lg cursor-not-allowed text-sm font-medium">
